...
const (
	...
	ModeAnalystName            = "Analysis"
	ModeAnalystDescription     = "Deeper analysis to examine motives and patterns."
)
...
const (
	...
	UnsavedSessionQuitMsg    = "Unsaved Analysis session will be discarded. Use /wrap to save it, or press Ctrl+C again to quit without saving."
)
...
const (
	...
	AnalystWelcomeMessage           = "Welcome. This space is for slow, honest analysis. We can look directly at patterns, tensions, and the meanings underneath what is happening."
	AnalystFreshStartMessage        = "We do not have a saved session summary yet, so we can start wherever feels most significant right now."
	AnalystReturningFallbackMessage = "I reviewed the last saved summary. We can pick up from a recurring pattern, an unresolved tension, or a question that still feels unfinished."
)
